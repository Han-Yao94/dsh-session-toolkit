...
|---|---|---|
| `lib/index.js` | `EAF7B4E9495CA4B274AB35CD0BF7B2931EB22B663752163541C75EA4F9A4A0DA` | 4422 |
| `lib/identity.js` | `D962C83A5EBC67B6B7B5C0EF93C75B6F4A1E44B2B61CE8C13303B69BF1AD02C7` | 2854 |
| `lib/global-prompt.js` | `A3D8392C856F05203631A51353F72A383D49FDBBE955DDFB0BD7A8C6B5371934` | 13280 |
| `lib/auto-resume.js` | `3D1006169E56EFD9F31E3757135AB227DA7A78659A09A618F7FAF7DA479EB097` | 10582 |
...
| `lib/ui-config.js` | `0F3DC89775A19AD06AD4030DDF9FA2DED7505579AEF997DABFAE8C340BE4D0CE` | 1902 |
| `lib/web-restart.js` | `D1C277841A2A9BDB9205EC2B45128020B00907F30C5101A96D65C4A13D5B6C14` | 8880 |
| `lib/peer-message.js` | `FDACB1756F142BA7A7215575407F0B0B51028CD39642F844DB8319A32F497A94` | 6598 |
| `lib/log-reposition.js` | `491282BF9C233C5449E96C3F203663B59B63A229AA22CEF48E5931E49CD0B03E` | 280 |
| `client/client.js` | `E5802B7D249E4087FDF8A51F85E0499AA1A005D58193CDC8D47C11EE2498B297` | 123798 |
| `package.json` | `D82BB1E63B67B3D44C881701C5E7042429599075822344B92B8BDC975D22B2D7` | 1787 |
| `README.zh.md` | `728B81DEE3E1903BD252933CDA60732F4B50B011F0194B5FF4FEBA748E8EF6DE` | 31654 |
...
9. 上述两条工具都需要**外部输入**（已装 profile / harness checkout），因此**不挂 CI**——CI 只有插件仓库本身，挂上去只会得到「未完成验证（exit 3）」的假红。它们属于升级/发布前的人工验收步骤。
...
| 6 | UI 旋钮改走 `session-toolkit-ui` 命名空间（`config.client` 作为 base） | `lib/ui-config.js`、`client/client.js` | client 条目无 config 通道、bundle 无 schemastery → 此前所有 `client.*` 配置键都是死键 |
