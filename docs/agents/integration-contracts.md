...
| `lib/peer-message.js` | `10ECA923B8336E530C133391A51121DF95C3A2E6B3995284ECC7F7350790BFDD` | 9233 |
...
| `README.zh.md` | `35D03E441EAAF64B5FEDEADB986D427A5A401251A67F5990C28204881C67AE89` | 39980 |
...
| `ctx.inject(['tools'], cb)` + `defineTool({...})` + `tools.register(tool)` | `lib/peer-message.js:15`、`:51,144`（send）、`:146,161`（list）（**两次更正**：本行原写 `:123`/`:125`/`:140`，比真实值小 5；`lib/peer-message.js` 里 2026-09-24 补 `wakingAfterAbort` 注释（+7 行）后，本行的 `:137`/`:139`/`:154` 又整体平移 +7 成 `:144`/`:146`/`:161`） | `packages/core/tools`、`@deepseek-ai/dsh-tools` | `send_to_session` / `list_sessions` 从工具面消失 |
