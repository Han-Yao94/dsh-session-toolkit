window.__ModuleLoader__.load({
  ...
  var CSS = [
    ...
    '.si-switch.on{background:var(--dsw-alias-button-primary-fill)}',
    ...
    '.si-area:focus{outline:none;border-color:var(--dsw-alias-button-primary-fill);box-shadow:0 0 0 3px var(--dsw-alias-interactive-bg-hover-accent)}',
    ...
    '.si-link{padding:0;border:none;background:none;font-family:inherit;font-size:13px;font-weight:500;color:var(--dsw-alias-state-business-primary);cursor:pointer;text-align:left}',
    '.si-link:hover{color:var(--dsw-alias-state-business-primary)}',
    ...
    '.si-save{background:var(--dsw-alias-button-primary-fill);color:#fff}',
    '.si-save:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}',
    ...
    '.si-btn:focus-visible,.si-switch:focus-visible,.si-link:focus-visible,.si-back:focus-visible,.si-close:focus-visible{outline:2px solid var(--dsw-alias-button-primary-fill);outline-offset:2px}',
...
collect('identity', apply);
  ...
  var CSS = [
    ...
    '.dsw-card{width:100%;background:var(--dsw-bg-card);border:1px solid var(--dsw-border-l1);border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.04);padding:24px 28px;display:flex;flex-direction:column;box-sizing:border-box;transition:background .2s ease,border-color .2s ease,box-shadow .2s ease}',
