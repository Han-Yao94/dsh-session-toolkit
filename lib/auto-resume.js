...
export const inject = ['settings', 'agents', 'sessionPersistence', 'agentDefaultModel']
...
export function apply(ctx) {
  ...
  async function resumeOne(sessionId) {
    ...
    try {
      ...
      const agentOptions = {}
      const dm = ctx.agentDefaultModel ? ctx.agentDefaultModel.currentSelection() : undefined
